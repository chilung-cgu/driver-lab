...
- repo 既有導讀：[`../../docs/concepts/pcie-primer.md`](../../docs/concepts/pcie-primer.md)、[`../../docs/onboarding/START-HERE.md`](../../docs/onboarding/START-HERE.md)、[`../../docs/guides/qemu-edu-first-pass.md`](../../docs/guides/qemu-edu-first-pass.md)。
