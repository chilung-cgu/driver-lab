...
- [`../docs/onboarding/check-kernel-env-explained.md`](../docs/onboarding/check-kernel-env-explained.md)：用範例輸出教你怎麼讀結果。
...
| [`../docs/onboarding/check-kernel-env-explained.md`](../docs/onboarding/check-kernel-env-explained.md) | 用範例輸出說明每一行健檢結果。 |
