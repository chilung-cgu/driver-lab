...
1. [`../onboarding/03-to-05-concurrency-pci-bridge.md`](../onboarding/03-to-05-concurrency-pci-bridge.md) 的`04 → 05`。
...
9. [`../../labs/05-pci-edu-mmio/debug-checklist.md`](../../labs/05-pci-edu-mmio/debug-checklist.md)、[`../reference/common-failures.md`](../reference/common-failures.md)、[`../reference/debugging-playbook.md`](../reference/debugging-playbook.md)。
10. 最後讀 [`../onboarding/05-to-07-pci-irq-dma-bridge.md`](../onboarding/05-to-07-pci-irq-dma-bridge.md)，只先看後續地圖。
